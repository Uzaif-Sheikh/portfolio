      ...
      <AppBar position="static" className="app-bar-below">
        <div className="flex-centre">
          <div className="a-links">
            <a target="__blank" href="https://github.com/Uzaif-Sheikh" className="cont-link"><img src={github} width="30px" height="30px"/></a>
            <a target="__blank" href="https://www.linkedin.com/in/uzaif-sheikh-29b607187/" className="cont-link"><img src={linkedin} width="30px" height="30px"/></a>
          </div>
        </div>
      </AppBar>
    </header>
