      ...
      <AppBar position="static" className="app-bar">
            <div className="flex-centre">
                ...
                <Link to="/home"><img className="logoo" src={logo} alt="u.svg" width="40px" height="40px"></img></Link>
                    ...
                    { minWind ? <Link className="link-btn" to="/projects"><img src={work} width="50px" height="50px"/></Link> : <Link className="link-btn" to="/projects"><img src={work} width="50px" height="50px"/>Work</Link>}
